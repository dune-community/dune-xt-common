...
void addbind_init_mpi(pybind11::module& m)
{
...
void addbind_init_logger(pybind11::module& m)
{
  using namespace pybind11::literals;
...
void addbind_test_logger(pybind11::module& m, const std::string& logger_prefix)
{
  using namespace pybind11::literals;

  m.def("_test_logger",
        [&](const bool info, const bool debug, const bool warning) {
          auto logger = Dune::XT::Common::TimedLogger().get(logger_prefix);
          if (info)
