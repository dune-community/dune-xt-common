...
void DUNE_DEPRECATED_MSG("Will be removed soon, file an issue on https://github.com/wwu-numerik/dune-stuff/issues if "
                         "you need this (09.02.2015)!") oneLinePrint(std::ostream& stream, const DiscFunc& func)
{
...
class DUNE_DEPRECATED_MSG("Will be removed soon, file an issue on https://github.com/wwu-numerik/dune-stuff/issues if "
                          "you need this (09.02.2015)!") LocalMatrixPrintFunctor
{
public:
...
class DUNE_DEPRECATED_MSG("Will be removed soon, file an issue on https://github.com/wwu-numerik/dune-stuff/issues if "
                          "you need this (09.02.2015)!") LocalFunctionPrintFunctor
{
public:
...
class DUNE_DEPRECATED_MSG("Will be removed soon, file an issue on https://github.com/wwu-numerik/dune-stuff/issues if "
                          "you need this (09.02.2015)!") LocalFunctionVerbatimPrintFunctor
{
public:
