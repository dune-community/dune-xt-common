...
#warning This header is deprecated, include <dune/stuff/common/configuration.hh> instead and use Configuration instead of ConfigContainer!
...
class DUNE_DEPRECATED_MSG("Use Configuration instead!") ConfigContainer : public Dune::ParameterTree
{
  typedef Dune::ParameterTree BaseType;
  typedef std::map<std::string, std::set<Request>> RequestMapType;

public:
  ConfigContainer(const bool record_defaults = internal::configuration_record_defaults,
  ...
  ConfigContainer(const ParameterTree& tree, const bool record_defaults = internal::configuration_record_defaults,
                  const bool warn_on_default_access = internal::configuration_warn_on_default_access,
                  const bool log_on_exit            = internal::configuration_log_on_exit,
                  const std::string logfile = internal::configuration_logfile);
  ...
  ConfigContainer(int argc, char** argv, const bool record_defaults = internal::configuration_record_defaults,
                  const bool warn_on_default_access = internal::configuration_warn_on_default_access,
                  const bool log_on_exit            = internal::configuration_log_on_exit,
                  const std::string logfile = internal::configuration_logfile);
