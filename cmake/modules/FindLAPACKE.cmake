...
if(NOT MKL_FOUND)
  ...
  find_library(LAPACKE_LIBRARY lapacke HINTS "${CMAKE_SOURCE_DIR}/../local/lib/" "${CMAKE_SOURCE_DIR}/../local/environments/debian-minimal/local/lib/")
  ...
  find_path(LAPACKE_INCLUDE_DIRS lapacke.h HINTS "${CMAKE_SOURCE_DIR}/../local/include/" "${CMAKE_SOURCE_DIR}/../local/environments/debian-minimal/local/include/")
