...
else(DEFINED dune-xt_MODULE_PATH) # xt itself
...
macro(add_header_listing) # header
  file(GLOB_RECURSE xt "${CMAKE_CURRENT_SOURCE_DIR}/dune/*.hh" "${CMAKE_CURRENT_SOURCE_DIR}/dune/*.pbh")
  set(COMMON_HEADER ${xt} ${DUNE_HEADERS})
