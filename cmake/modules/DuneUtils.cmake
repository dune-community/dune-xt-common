...
macro(END_TESTCASES)
    ...
    foreach( test ${testnames} )
        ...
        # cmake >= 3.1 forbids setting flags on non-compilable targets
        get_property(target_type TARGET ${test} PROPERTY TYPE)
        if(COMMAND add_dune_tbb_flags AND TBB_FOUND AND (target_type STREQUAL 'EXECUTABLE'))
