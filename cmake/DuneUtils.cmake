...
MACRO( HEADERCHECK )
	...
	FOREACH( HEADER ${ARGN} )
		...
		configure_file( ${PROJECT_SOURCE_DIR}/../dune-stuff/cmake/headercheck.cpp.in ${CMAKE_CURRENT_BINARY_DIR}/headercheck/${TEST_NAME}.cpp )
...
MACRO( ADD_CPPCHECK )
	...
	IF( EXISTS ${CPPCHECK_BINARY} )
		...
		TO_LIST_SPACES( CPPCHECK_FLAGS_SPLIT )
...
MACRO( ADD_DUNE_MODULES )
	FOREACH( MODULE ${ARGN} )
		...
		list( APPEND DUNE_MODULE_DIRS ${CMAKE_CURRENT_SOURCE_DIR}/../dune-${MODULE})
