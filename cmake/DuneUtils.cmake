...
MACRO( ADD_CPPCHECK )
	ADD_CUSTOM_TARGET( cppcheck SOURCES ${ARGN} )
	FOREACH( SOURCEFILE ${ARGN} )
		GET_FILENAME_COMPONENT( fn ${SOURCEFILE} NAME )
		SET( TEST_NAME "cppcheck_${fn}")
		SET( CPPCHECK_FLAGS ${PLAIN_INCLUDE_DIRS} )
		LIST(APPEND CPPCHECK_FLAGS "--enable=all" "--report-progress" "-f" "-v" )
		TO_LIST_SPACES( CPPCHECK_FLAGS TEST_NAME_FLAGS )
		SET(XARGS ${TEST_NAME_FLAGS} ${CMAKE_CURRENT_SOURCE_DIR}/${SOURCEFILE} )#&> ${CMAKE_CURRENT_BINARY_DIR}/cppcheck_report_${fn}.txt )
		ADD_CUSTOM_TARGET(  ${TEST_NAME} cppcheck ${XARGS} )
		ADD_TEST( ${TEST_NAME} ${CMAKE_CXX_COMPILER} ${XARGS} )	
		add_dependencies( cppcheck ${TEST_NAME} )
