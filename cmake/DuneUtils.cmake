...
MACRO(INCLUDE_SYS_DIR)
	FOREACH( ARG ${ARGN} )
# 		INCLUDE_DIRECTORIES(${ARG})
		LIST(APPEND MY_CXX_FLAGS "-isystem${ARG}" "-I${ARG}")
    ENDFOREACH( ARG )
ENDMACRO(INCLUDE_SYS_DIR)

MACRO( HEADERCHECK )
	ADD_CUSTOM_TARGET( headercheck ALL SOURCES ${ARGN} )
	FOREACH( HEADER ${ARGN} )
		...
		ADD_CUSTOM_COMMAND(  TARGET headercheck
			PRE_BUILD
			COMMAND ${CMAKE_CXX_COMPILER} ${XARGS}
			VERBATIM )
