...
static inline void add_initialization(pybind11::module& m, std::string logger_name)
{
...
static inline void try_register(pybind11::module& m, const std::function<void(pybind11::module&)>& registrar)
{
  try {
    registrar(m);
